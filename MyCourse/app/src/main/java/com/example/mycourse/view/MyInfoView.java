...
import com.example.mycourse.activity.SettingActivity;
import com.example.mycourse.activity.UserInfoActivity;
...
public class MyInfoView {
    ...
    private void initView() {
        //设置布局文件
        mCurrentView = mInflator.inflate(R.layout.main_view_myinfo, null);
